        ...
        try:
            ...
            if Tarjeta.query.count() == 0:
                ...
                bancos_data = [
                    ...
                    {'email': 'nu@banco.com',        'nombre': 'Rep. Nu',        'banco': 'Nu México'},
                ]
                bancos_creados = {}
                ...
                tarjetas_data = [
                    ('BBVA Azul Estudiante',   'BBVA México',  'estudiante', 24.5, 0,    18, 'Sin anualidad, cashback 3% en gastos escolares, seguro de compras'),
                    ('BBVA Oro Joven',         'BBVA México',  'joven',      26.8, 450,  21, 'Puntos BBVA, acceso a promociones exclusivas, seguro de viaje'),
                    ('BBVA Platino Clásica',   'BBVA México',  'clasica',    29.2, 800,  25, 'Salas VIP, asistencia médica, reembolso en gasolina'),
                    ('Santander Like U',       'Santander',    'joven',      28.0, 0,    18, 'Sin anualidad, descuentos en Spotify, Netflix y cines'),
                    ('Santander Free',         'Santander',    'estudiante', 25.5, 0,    18, 'Sin anualidad, seguro de accidentes, descuentos en comercios'),
                    ('Citibanamex Estudiante', 'Citibanamex',  'estudiante', 22.0, 0,    18, 'Sin anualidad, cashback 1%, seguro de vida incluido'),
                    ('Citibanamex Platinum',   'Citibanamex',  'clasica',    31.0, 1500, 25, 'Puntos ThankYou, concierge 24/7, acceso a lounges'),
                    ('HSBC Zero',              'HSBC',         'joven',      30.0, 0,    21, 'Sin anualidad, MSI en compras, descuentos en gasolina'),
                    ('HSBC Advance',           'HSBC',         'clasica',    33.0, 1800, 24, 'Recompensas, eventos exclusivos, seguro de viaje'),
                    ('Banorte Joven',          'Banorte',      'joven',      27.0, 300,  18, 'Cashback 0.5%, descuentos en delivery y entretenimiento'),
                    ('Nu Ultravioleta',        'Nu México',    'estudiante', 35.0, 0,    18, 'Cashback automático 1%, sin comisiones, todo desde la app'),
                    ('Nu Gold',                'Nu México',    'joven',      39.0, 0,    20, 'Cashback 2%, límite flexible, sin letra pequeña'),
                ]
